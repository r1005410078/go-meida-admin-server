...
func main() {
	...
	bus.Register(houseServices.SaveHouseTagsEventHandle)
	bus.Register(houseServices.SaveHouseMediasEventHandle)
	...
	houseRouter.DELETE("/delete/:id", houseHttpHandlers.DeleteHouseHandler)
